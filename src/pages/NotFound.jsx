...
export default function NotFound() {
  return (
    <main
      role="main"
      className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-6 text-center"
    >
      ...
      {/* Error Title */}
      <h1 className="text-6xl sm:text-7xl font-extrabold mb-4 text-gray-800 dark:text-white">
        404
      </h1>
